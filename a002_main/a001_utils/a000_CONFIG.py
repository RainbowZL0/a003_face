from a002_main.a001_utils.a003_logger import build_logger_with_handler
...
TEST_LOG_PATH = r"./a002_main/a002_batch_test/log"
...
TRAINING_SAVE_MODEL_TO_FOLDER = "./a002_main/a003_training/saved_history/models"
TRAINING_VALI_SET_RATIO = 0.1
TRAINING_USING_GRAY_IMAGE = True
TRAINING_TENSOR_BOARD_LOG_DIR = "./a002_main/a003_training/runs"

WHETHER_USING_SAVED_STATE = False
LOAD_FROM_STATE_PATH = (r"./a002_main/a003_training/saved_history/models/"
                        r"12-10-19-47-08_epochs-2_iters-up-to-now-312.pth")

VALI_SAMPLES_NUM = 5000
VALI_BATCH_SIZE = 64
TRAINING_VALI_INTERVAL_IN_ITERS = 200
VALI_LOG_FOLDER = r"./a002_main/a003_training/saved_history/validation"
VALI_ANALYZE_USING_DETAILED_RESULT_JS_NAME = "---------.json"
LOSS_FUNC_MARGIN = 0.7  # 负样本距离减去正样本距离小于MARGIN的组需要学习
LOSS_FUNC_SWAP = True
LOSS_FUNC_USING_SELF_DEFINED = False
LOSS_FUNC_WEIGHT_D_AN_PENALTY = 0

FASTAPI_UPLOAD_IMAGE_FOLDER = r"./a002_main/a004_fastapi/a001_images/a001_upload_images"
FASTAPI_CROP_IMAGE_FOLDER = r"./a002_main/a004_fastapi/a001_images/a002_crop"
FASTAPI_DEVICE = "cpu"
FASTAPI_USING_DETECTION_METHOD = "mtcnn"  # deepface or opencv
FASTAPI_PORT = 8092
FASTAPI_LOG_JSON_FILE_PATH = r"./a002_main/a004_fastapi/a003_logs/log.json"
